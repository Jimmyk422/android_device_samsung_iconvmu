...
void sensor_rough_control(void *arg);
void sensor_rough_control_sr130pc10(void *arg);
void sensor_rough_control_sr030pc30(void *arg);
/* ADD FOR OEM CAMERA END */
...
#define MSM_CAM_IOCTL_PCAM_CTRL_8BIT \
	_IOWR(MSM_CAM_IOCTL_MAGIC, 60, struct ioctl_pcam_info_8bit)
#define MSM_CAM_IOCTL_PCAM_CTRL_8BIT_FRONT \
		_IOWR(MSM_CAM_IOCTL_MAGIC, 61, struct ioctl_pcam_info_8bit)
/* ADD FOR OEM CAMERA END */
/* For ISX012 */
struct sensor_ext_cfg_data {
	uint32_t cmd;
	uint32_t  value_1;
	uint32_t  value_2;
	void *value_string;
...
#define MSM_CAM_IOCTL_EXT_CONFIG \
		_IOWR(MSM_CAM_IOCTL_MAGIC, 62, struct sensor_ext_cfg_data)
...
#define CFG_SET_SCENE_MODE    36
#define CFG_SET_ISO    37
#define CFG_SET_FLASH			38
#define CFG_SET_DATALINE_CHECK	39
#define CFG_SET_EXPOSURE_VALUE	40
#define CFG_SET_ROTATION			41
#define CFG_MAX			42
...
#define SENSOR_VIDEO_120FPS_MODE	7
...
/* ADD FOR OEM CAMERA START */
/* Need to modify */
#define CAMERA_EXPOSURE_NEGATIVE_4	0
#define CAMERA_EXPOSURE_NEGATIVE_3	1
#define CAMERA_EXPOSURE_NEGATIVE_2	2
#define CAMERA_EXPOSURE_NEGATIVE_1	3
#define CAMERA_EXPOSURE_0				4
#define CAMERA_EXPOSURE_POSITIVE_1	5
#define CAMERA_EXPOSURE_POSITIVE_2	6
#define CAMERA_EXPOSURE_POSITIVE_3	7
#define CAMERA_EXPOSURE_POSITIVE_4	8
/* ADD FOR OEM CAMERA END */
...
#define CAMERA_SCENE_SPORTS			9
#define CAMERA_SCENE_STEADYPHOTO		10
#define CAMERA_SCENE_FLOWER			11
#define CAMERA_SCENE_CANDLE			12
#define CAMERA_SCENE_FIREWORKS		13
#define CAMERA_SCENE_PARTY			14
#define CAMERA_SCENE_NIGHT_PORT		15
#define CAMERA_SCENE_THEATRE			16
#define CAMERA_SCENE_ACTION			17
#define CAMERA_SCENE_AR				18
...
enum ext_cfg_command {
	...
	EXT_CFG_SET_AF_STOP,
	EXT_CFG_SET_AF_STATUS,
	EXT_CFG_SET_AF_OPERATION,
	EXT_CFG_SET_TOUCHAF_MODE,
...
/* ADD FOR OEM CAMERA START */
/* Need to add on the vendor hal */
#define CAMERA_AEC_FRAME_AVERAGE_S	0
#define CAMERA_AEC_CENTER_WEIGHTED_S		1
#define CAMERA_AEC_SPOT_METERING_S		2
...
/* Need to modify */
#define  AF_MODE_MACRO_S		1
#define  AF_MODE_AUTO_S		2
#define  AF_MODE_NORMAL_S		3
#define  AF_MODE_START		5
#define  AF_MODE_PREFLASH	6

/* Need to modify */
#define  FLASH_MODE_OFF_S		0
#define  FLASH_MODE_ON_S		1
#define  FLASH_MODE_AUTO_S	2
#define  FLASH_TORCH_MODE_ON_S	3
#define  FLASH_OFF_S	4
#define  FLASH_TORCH_ON_S	5
